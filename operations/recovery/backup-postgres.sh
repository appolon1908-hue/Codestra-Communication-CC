...
required=(PGHOST PGPORT PGDATABASE PGUSER PGPASSFILE CODESTRA_COMMUNICATION_BACKUP_ROOT CODESTRA_RELEASE_SHA CODESTRA_IMAGE_DIGEST CODESTRA_BACKUP_GPG_RECIPIENT)
